  ...
  members: {
    council: [
      ...
      },
      {
        ...
        text: '从需要老人带的萌新，到主要参与一个大项目，一开始的时候其实并不知道自己能做成一些什么东西，也怕以自己的精力和经历承担不了太多的东西，但庆幸自己还是坚持了下来，生活更充实更有目标～<br>目前分管协会对内事物，相信更多付出，更多收获，目标与大家一起追求卓越！',
        isTextShow: false,
    ...
    hr: [
      ...
      {
        name: '财务秘书：陈然 - 软工',
        brief: '遇到几个志趣相同的朋友，还有温暖的大家',
        text: '有幸与 SCDA 结缘 1 年半之久，最开心的是认识了各种各样的人。<br>领导力十足、轻松去除尴尬气氛的学长。<br>萌萌哒美美哒教会我吃喝玩piao乐du的学姐。<br>思想深刻知识广博，交谈使我受益匪浅的学长。<br>温柔可亲细心教导诸多事项的学姐。<br>优秀的大家，使我也不自觉想变得更好。<br>对你，最大的感情就是感激吧。<br>谢谢你，SCDA。<br>',
        isTextShow: false,
        img: imageDir + 'humanResource/chenran.jpg',
      },
      {
        name: '邵悠然 - 化工',
        brief: '爱自己是终生浪漫的开始',
      ...
      },
      {
        name: '康牧天 - 化工',
        brief: '在这里，你将真正被夸奖',
        text: '我是一点也不帅一点也不暖一点也不可爱的天天，不爱吃喝不爱浪只喜欢科研和学习，谢谢大家mua。<br>正式感言：天真的自己当初向往着高冷的SCDA，却没想到会遇到这么温暖包容的团体，遇到这么多超级好看性格随和的妹子和暖心的汉子们，在我还不老的年华，因为刚好遇见你，留下足迹才美丽，如果再相遇，我想，一定会记得你。',
        isTextShow: false,
        img: imageDir + 'humanResource/tiantian.jpg',
      },
      {
        name: '杨璐敏 - 数媒',
        brief: '在这你能遇见各色各样的人，与他们结识共事，感受思维和人格魅力的碰撞。',
        text: '',
        isTextShow: false,
        img: imageDir + 'humanResource/lumin.jpg',
      },
      {
        name: '田野 - 电气',
