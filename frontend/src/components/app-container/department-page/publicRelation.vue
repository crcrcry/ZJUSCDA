<template>
  <div id="container">
    <el-row :gutter="10">
      <el-col :span="12">
        <div v-for="item in text" class="paragraph">
          {{ item }}
        </div>
      </el-col>
      ...
      <el-col :span="12" id="title">
        ...
        <el-row>
          <div>
            <el-row id="name">媒体运营中心</el-row>
            <el-row id="ename">Media Operation Center</el-row>
          </div>
        </el-row>
      </el-col>
    </el-row>
...
<script>
  ...
  export default {
    ...
    computed: {
      text() {
        return [ ...this.$store.state.department.pr.text ];
      },
      image() {
        return [ ...this.$store.state.department.pr.imgUrl ];
      }
    }
  }
</script>
...
<style scoped>
  ...
  .paragraph{
    padding: 2.3vh 0% 0% 3%;
    font: 300 22px/34px "PingFang SC";
    text-indent: 2em;
  }
  ...
  @media (max-width: 1420px) {
    ...
    .paragraph{
      font: 300 18px/27px "PingFang SC";
      text-indent: 2em;
    }
  }
  ...
  @media (max-width: 1700px) and (min-width: 1421px) {
    ...
    .paragraph{
      font: 300 22px/32px "PingFang SC";
      text-indent: 2em;
    }
  }
</style>
